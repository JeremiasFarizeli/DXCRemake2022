...
<script src="../js/001_aguardandoRetirada.js"></script>
                ...
                <div>
                    ...
                    <div style="width: 300px;"><br>
                        ...
                        <textarea class="texto1" name="" id="dxc-text-codEquipamento" cols="30"
                            rows="10">AGUARDANDO RETIRADA</textarea>
                    </div>
                    <br><br>
                    ...
                    <div class="div-texto2 ">
                        ...
                        <textarea class="texto2" name="" id="dxc-text-anotacaoes-aguardandoRetirada" cols="30"
                            rows="10">#AguardandoRetirada

Equipamento reparado, aguardando retirada.</textarea>
                    </div>
