...
<form method="POST" action="">
    <div id="dados"> <!-- Conteudo DADOS-->
        ...
        <div class="divbotoes">
            ...
            <div class="right">
                ...
                <input id="botaoGerar" onclick="formularioEncerrar()" type="button" value="GERAR" class="btnGerar"
                    class="btnGerar-info">
    ...
    <div id="tipificacao">
        ...
        <input id="incidentlexmarkOnOff" onclick="mostrarLexmarEncerramento()" type="checkbox"
            name="incidentlexmarkOnOff" value="incidentlexmarkOnOff"> CASO DE ATENDIMENTO LEXMARK<br>
